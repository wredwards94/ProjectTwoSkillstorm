    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Billings_PhonePlans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "PhonePlans",
                        principalColumn: "PlanId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Billings_UserPlans_UserPlanId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "5088b294-d760-47e5-9b12-07fb79bd3f4b", null, "Professor", "PROFESSOR" },
                    { "91e941cb-a6c3-4d59-81b6-81b9ce98774e", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "25f87c58-9061-4bb7-aa3a-4a05177481d2", 0, "123 Main St", "8d59c2d1-cfe1-4d73-86e9-3042212e567e", "john.doe@example.com", false, "John", "Doe", false, null, null, null, "password1", null, false, "23476b19-8208-44d1-a912-cb419d28f39e", false, "johndoe" },
                    { "3f86cc51-c688-42de-aa44-d35c5db73bc4", 0, "789 Loon St", "8c21d17f-4d5c-4425-ab97-0173975804cf", "elmer.fudd@example.com", false, "Elmer", "Fudd", false, null, null, null, "password3", null, false, "63ddf8e3-061a-44c9-a121-11f439e40dd9", false, "elmerfudd" },
                    { "538091ec-802c-460d-a56e-8ce2414782b2", 0, "456 Elm St", "0a0dc04e-8217-43b8-8511-c13d1cc888ea", "jane.smith@example.com", false, "Jane", "Smith", false, null, null, null, "password2", null, false, "739cd48c-1438-4311-9366-28b488f230de", false, "janesmith" }
                });

            migrationBuilder.InsertData(
                table: "Devices",
                columns: new[] { "DeviceId", "Color", "Manufacturer", "Model", "Storage" },
                values: new object[,]
                {
                    { new Guid("4f05e337-e657-4848-9efe-8b291bf18f1f"), "Violet", "Google", "Pixel 7", "256GB" },
                    { new Guid("6488bdee-e52c-442a-b754-8a8f6c0e5ce0"), "Red", "Motorola", "Razr Plus", "128GB" },
                    { new Guid("7b483b60-90e2-4c89-836c-4ad8946b8aa7"), "Grey", "Samsung", "Galaxy S24 Ultra", "128GB" },
                    { new Guid("86a2e9d1-881f-4aba-ba25-e563b460a97a"), "Blue", "Samsung", "iPhone 15 Plus", "128GB" },
                    { new Guid("88ca3741-b8f4-44f6-baef-059389a34907"), "White", "Apple", "iPhone 13", "64GB" },
                    { new Guid("913cdb0e-2618-4c30-b760-0a78857eb0dd"), "Blue", "Apple", "iPhone 12", "128GB" },
                    { new Guid("97a612e4-13d6-43c0-805b-30fafa1ae05a"), "Mint Blue", "Google", "Pixel 8 Pro", "128GB" },
                    { new Guid("baf6fd9a-ee78-4512-b298-03bd824f3fbd"), "Purple", "Samsung", "Galaxy S21+", "512GB" },
                    { new Guid("cde3cf86-46fb-40b3-bd45-e64171469e9b"), "Black", "Apple", "iPhone 15 Plus", "64GB" },
                    { new Guid("f5222ea1-947e-45c1-a59a-a5a6e296b902"), "Blue", "Apple", "iPhone 15", "256GB" }
                });
